...
var ArchivedTodosPage = /** @class */ (function () {
    ...
    ArchivedTodosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-archived-todos',template:/*ion-inline-start:"/Users/abhinav/Documents/Learning/todo/src/pages/archived-todos/archived-todos.html"*/'<!--\n  Generated template for the ArchivedTodosPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>ArchivedTodos</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <ion-list > \n        <ion-item-sliding *ngFor="let i of archivedTodo; let todoIndex = index"> \n        <ion-item>{{i}}</ion-item>\n        <ion-item-options side="right">\n          <button ion-button color="success" (click)="addBack(todoIndex)">\n            <ion-icon name="add" ></ion-icon>\n          </button>\n        </ion-item-options>\n        </ion-item-sliding>\n      </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/abhinav/Documents/Learning/todo/src/pages/archived-todos/archived-todos.html"*/,
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-home",template:/*ion-inline-start:"/Users/abhinav/Documents/Learning/todo/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      ToDo List\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button *ngIf="!reorderIsEnable" (click)="toggleReorder()"> <ion-icon name="build"></ion-icon></button>\n      <button ion-button *ngIf="reorderIsEnable" (click)="toggleReorder()"><ion-icon name="done-all"></ion-icon></button>\n      <button ion-button (click)="openTodoAlert()">\n          <ion-icon name="add-circle"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list  [reorder]="reorderIsEnable" (ionItemReorder)="itemReorder($event)"> \n    <ion-item-sliding *ngFor="let i of todo; let todoIndex = index"> \n    <ion-item>{{i}}</ion-item>\n    <ion-item-options side="right">\n      <button ion-button color="danger" (click)="delete(todoIndex)">\n        <ion-icon name="trash" ></ion-icon>\n      </button>\n    </ion-item-options>\n    <ion-item-options side="left">\n        <button ion-button color="primary" (click)="editTodo(todoIndex)">\n          <ion-icon name="edit" ></ion-icon>\n        </button>\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n\n  <ion-fab right bottom>\n    <button ion-fab (click)="gotToHome()">\n      <ion-icon name="archive"></ion-icon>\n    </button>\n  </ion-fab>\n</ion-content>\n'/*ion-inline-end:"/Users/abhinav/Documents/Learning/todo/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__providers_todo_todo__["a" /* TodoProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_todo_todo__["a" /* TodoProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ToastController */]) === "function" && _d || Object])
    ], HomePage);
    return HomePage;
    var _a, _b, _c, _d;
}());
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/abhinav/Documents/Learning/todo/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/abhinav/Documents/Learning/todo/src/app/app.html"*/
        }),
